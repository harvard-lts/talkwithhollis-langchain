...
async def main(human_input_text):
    ...
    # response = requests.get("https://api-na.hosted.exlibrisgroup.com/primo/v1/search?scope=default_scope&tab=books&vid=HVD2&limit=100&offset=0&apikey=l8xxe836c3c488144a168a0e82eb61e26c2d&q=title,contains,bio%20engineering&multiFacets=facet_rtype,include,books%7C,%7Cfacet_library,include,BAK&facet_library,include,FUN&facet_library,include,KSG%7C,%7Cfacet_tlevel,include,available_onsite")
